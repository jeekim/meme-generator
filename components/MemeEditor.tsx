  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl p-6 flex flex-col space-y-6">
        <div>
          <label htmlFor="top-text" className="block text-sm font-medium text-gray-400 mb-2">
            Top Text
          </label>
          <input
            id="top-text"
        ...
        <div>
          <label htmlFor="bottom-text" className="block text-sm font-medium text-gray-400 mb-2">
            Bottom Text
          </label>
          <input
            id="bottom-text"
            ...
            <div className="space-y-2">
              {suggestedCaptions.map((caption, index) => (
                <button
                  ...
                  className="w-full text-left p-3 bg-gray-700 hover:bg-gray-600/80 rounded-md text-sm transition"
                >
                  <p>
                    <strong>Top:</strong> {caption.topText}
                  </p>
                  <p>
                    <strong>Bottom:</strong> {caption.bottomText}
                  </p>
                </button>
              ))}
            </div>
        ...
        <div className="border-t border-gray-700 pt-6 space-y-4">
          <form onSubmit={handleEditSubmit} className="space-y-4">
            <label htmlFor="magic-edit" className="block text-lg font-semibold text-white">
              Magic Edit
            </label>
            <input
              id="magic-edit"
